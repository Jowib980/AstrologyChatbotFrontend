          ...
          <div class="ast_menu">
            <ul>
              ...
              <li id="loggedInUser" style="display: none;">
                <i class="fa fa-user" aria-hidden="true"></i> <span id="usernameDisplay"></span>
              </li>
...
<script>
  ...
  document.addEventListener('DOMContentLoaded', function () {
    ...
    if (loggedInUser) loggedInUser.style.display = isLoggedIn ? "list-item" : "none";
    ...
    // Show/hide forms
    document.getElementById('boyFormSection').style.display = isLoggedIn ? 'block' : 'none';
    document.getElementById('girlFormSection').style.display = isLoggedIn ? 'block' : 'none';
